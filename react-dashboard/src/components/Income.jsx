...
const Income = ({ transactions, addTransaction, updateTransaction, deleteTransaction }) => {
  ...
  useEffect(() => {
    const filtered = transactions.filter(tx => {
      ...
      return tx.type === 'income' && matchesMonth && matchesSearch && matchesCategory
    })
    setFilteredIncomeTransactions(filtered)
    calculateIncome(filtered)
  }, [transactions, selectedMonth, searchTerm, selectedCategory])

  const calculateIncome = (transactionsToCalculate) => {
    let income = 0
        ...
        <div className="transactions-header">
          ...
          <div className="transactions-controls">
            ...
            >
              ...
              {[...new Set(transactions.filter(tx => tx.type === 'income').map(tx => tx.category))].map(category => (
